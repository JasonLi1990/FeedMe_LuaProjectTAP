...
-- The module about the graphics operations on the screen
-- @emulator gfx
...
-- @param width The width of the surface (Must be a positive integer and less than 10000.)
-- @param height The height of the surface (Must be a positive integer and less than 10000.)
-- @return surface The new surface with the width and height set
...
-- @param path The source path used to load the png image 
-- @return surface The surface of the new loaded png image
